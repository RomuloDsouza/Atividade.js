...
// let nome= prompt("Digite seu nome hospede ");
// console.log(`ola ${nome} digite 1 para fazer Check-in `)
// console.log(`ola ${nome} digite 2 chamar serviço de quarto `)
// console.log(`ola ${nome} digite 3 Fazer pedido `)
// console.log(`ola ${nome} digite 4  Fazer Check-out `)
...
// switch (opçoes ) {
//     case 1 :
//             console.log(`Ola, ${nome} o seu Check-in ja esta em processamento   `)
//         break;

//     case 2 :
//             console.log(`Ola, ${nome} o seu serviço de quarto ja esta em indo  `)
//         break;    

//         case 3 :
//             console.log(`Ola, ${nome} o seu pedido ja esta em processamento `)
//         break;       

//         case 4 :
//             console.log(`Ola, ${nome} o seu Check-out foi realizado `)
//         break;

//     default: console.log(`Ola, ${nome} digite a alternativa correta `)
//         break;
// }
